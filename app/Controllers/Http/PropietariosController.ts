...
export default class PropietariosController 
{
    ...
    {
        const newPropietarioSchema = schema.create({
        ...
        try
        {
            const data = await request.validate({
                ...
                messages: {
                    ...
                    'ap_paterno.alpha': 'El apellido paterno debe contener solo letras',
                    ...
                    'ap_materno.alpha': 'El apellido materno debe contener solo letras',
    ...
    public async eliminar({params,response}:HttpContextContract)
    {
        ...
        {        
            ...
            return response.ok({message:"se elimino"});
        }
        return response.notFound({message:"el propietario no existe"});
    ...
    {
        const propietario = await Propietario.all()
